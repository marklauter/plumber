...
- **`MSL.Plumber.Diagnostics`** — per-request OpenTelemetry tracing and metrics middleware. See [OpenTelemetry Extensions](https://github.com/marklauter/plumber/wiki/OpenTelemetry-Extensions).
